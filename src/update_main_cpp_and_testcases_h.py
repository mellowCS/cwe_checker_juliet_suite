...
def update_testcases_h(file_path, testcases_dot_h, fcl):
    ...
    update_file(file_path, testcases_dot_h, auto_gen_cpp_good_h_tag_start, auto_gen_cpp_good_h_tag_end,
                fcl.cpp_h_good_lines)
    update_file(file_path, testcases_dot_h, auto_gen_cpp_bad_h_tag_start, auto_gen_cpp_bad_h_tag_end,
                fcl.cpp_h_bad_lines)
